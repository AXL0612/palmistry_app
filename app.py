...
def predict():
    ...
    Tra ve JSON:
        {
          ...
          "disclaimer": "...",
          "results": {
             "sinh_dao":  { score, nhan, luan_giai, diem_noi_bat, loi_khuyen, ... },
             "su_nghiep": { ... },
             "tam_dao":   { ... },
             "tri_dao":   { ... }
          }
    ...
    # Chi giu lai score hop le de dua vao advice_engine; model loi se bao rieng
    scores = {
        key: info["score"]
    ...
    consultations = get_all_consultations(scores)
